...
<body>
    ...
    <div class="add container mt-5">
        <h1 class="add-titulo mb-4">Adicionar Ganho</h1>
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="descricao" placeholder="Ex: Salário Mensal">
            </div>

            <div class="form-group">
                <label for="valor">Valor:</label>
                <input type="number" class="form-control" id="valor" placeholder="Ex: 2500.00">
            </div>
